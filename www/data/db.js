...
(function() {
    ...
    var endpointSelector = new DevExpress.EndpointSelector(FallArmyworm.config.endpoints);
    var serviceConfig = $.extend(true, {}, FallArmyworm.config.services, {
        db: {
    ...
    FallArmyworm.db = new DevExpress.data.ODataContext(serviceConfig.db);
